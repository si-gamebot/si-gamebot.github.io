...
function verify1() {
    ...
    function getRoll(nonce, diceID, clientSeed) {
    ...
    if ( typeof p1cs === "undefined" )  return error_missing_params();
    if ( typeof p2cs === "undefined" )  return error_missing_params();
    if ( typeof  p1n === "undefined" )  return error_missing_params();
    if ( typeof  p2n === "undefined" )  return error_missing_params();
    if ( typeof    n === "undefined" )  return error_missing_params();
